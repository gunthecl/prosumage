...
*Try different startin values
*STO_L.l(sto,'h1')= 1.464;
*E_buy.l('h2')=  0.651;
...
E_purchased = sum((h),E_buy.l(h) );
E_sold      = sum((h),  E_sell.l(h));



display d , N_PV.l , N_STO_E.l, N_STO_P.l, Z.l, E_buy.l , E_sell.l ,
        STO_L.l, price_market, hh_energy_balance.m , E_purchased, E_sold;
