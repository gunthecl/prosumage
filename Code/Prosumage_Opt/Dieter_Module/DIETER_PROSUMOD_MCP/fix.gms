...
STO_IN_PRO2PRO.fx(sto_pro,res,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_IN_PRO2M.fx(res,sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_IN_M2PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_IN_M2M.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_OUT_PRO2PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_OUT_PRO2M.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_OUT_M2PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_OUT_M2M.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_L_PRO2PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_L_PRO2M.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_L_M2PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_L_M2M.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
N_STO_E_PRO.fx(sto_pro)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
N_STO_P_PRO.fx(sto_pro)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
STO_L_PRO.fx(sto_pro,h)$( m_sto_pro_p(sto_pro) = 0) = 0 ;
N_RES_PRO.fx(res_pro)$( m_res_pro(res_pro) = 0) = 0 ;
$ontext
$offtext
