...
%prosumage%$ontext
        ...
        report_prosumage_tech('Max load of prosumager demand in kW',loop_res_share,loop_prosumage,sto) =  max(report_hours('residual load prosumers',loop_res_share,loop_prosumage,h)) ;
        report_prosumage_tech('Max PV feed-in prosumager in kW',loop_res_share,loop_prosumage,sto) = -min(report_hours('residual load prosumers',loop_res_share,loop_prosumage,h));
