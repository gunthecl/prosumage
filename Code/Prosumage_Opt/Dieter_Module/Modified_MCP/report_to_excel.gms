...
%reserves%execute_unload "results_to_excel", excel_cost excel_capacities excel_res_curt excel_prices excel_dispatch
%heat%$ontext
%reserves% excel_cost_building_heat excel_cost_building_heat_other excel_cost_building excel_heat
$ontext
$offtext
;
...
%reserves%$ontext
execute_unload "results_to_excel", excel_cost excel_capacities excel_res_curt excel_prices excel_dispatch excel_reserves
%heat%$ontext
excel_cost_building_heat excel_cost_building_heat_other excel_cost_building excel_heat
$ontext
$offtext
;
