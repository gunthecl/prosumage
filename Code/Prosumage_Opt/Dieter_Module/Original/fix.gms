...
STO_L_PRO2M.fx(n,sto,h)      = 0 ;
STO_L_M2PRO.fx(n,sto,h)      = 0 ;
STO_L_M2M.fx(n,sto,h)        = 0 ;
$ontext
$offtext
...
lev_H_SETS_IN(superscen,n,bu,ch,h) = 0 ;
