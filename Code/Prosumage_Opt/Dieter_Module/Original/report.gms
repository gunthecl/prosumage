...
%EV%$ontext
        ...
        report_node('gross_energy_demand w/o EV',loop_res_share,loop_ev,loop_prosumage,n)$feat_node('ev',n) = sum(scen$(map(scen,loop_res_share,loop_ev,loop_prosumage)) , gross_energy_demand(scen,n)) - sum( (ev,h) , sum(scen$(map(scen,loop_res_share,loop_ev,loop_prosumage)) , lev_EV_GED(scen,n,ev,h)) ) ;
