...
$setglobal uploadfile "in"

* Auto set of output file (do not change)
$setglobal outputfile "results_MCP"
...
* Declare cost parameters for household
c_i_sto_e_hh  =  5418.14/1000/10  ;
c_i_sto_p_hh  = 50995.48/1000/10  ;
c_i_pv_hh     = 60526.64/1000/10  ;
...
* Load data for specific household and base year in MWh
...
KKTEB_hh(h)..
    ...
    lambda(h)/1000 + 0.25 - lambda_hh(h)  =G= 0
...
Z_hh.l                      =
         ...
         - sum(  h , price_market(h)/1000 * E_sell_hh.l (h))
;
...
display d_hh , N_PV_hh.l , E_buy_hh.l , E_sell_hh.l ,  G_PV_hh.l,
        ...
        lambda.l,  CU_hh.l, N_RENEWABLE.l, d, G_RENEWABLE.l,
