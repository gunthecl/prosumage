...
* ######
ev_quant         Overall number of electric vehicles
...
*### new:
c_i_sets_e(n,bu,ch) = heat_data(n,bu,ch,'annualized_cost') ;
c_i_sets_dhw_e(n,bu,ch) = heat_data(n,bu,ch,'annualized_cost_dhw') ;
